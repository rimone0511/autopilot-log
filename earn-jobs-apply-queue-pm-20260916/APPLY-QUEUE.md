...
Max **2** concrete jobs. Both URLs were **`open_read`** this PM. Fill locally. **Do not send.**
...
| Draft pointer | Prefer [#81](https://github.com/rimone0511/autopilot-log/pull/81) `05-inquiry-ai-ops.md` / `06-custom-ai-ops.md` · fallback [#11](https://github.com/rimone0511/autopilot-log/pull/11) `03-llm-ops-coconala-estimate.md` · showcase voice [#122](https://github.com/rimone0511/autopilot-log/pull/122) `JP/coconala-inquiry-reply-template.md`. **Do not paste the 5258870 letter onto this ID.** |
...
| Draft pointer | Angle only from [#92](https://github.com/rimone0511/autopilot-log/pull/92) `01-5258870-python-youtube-generation.md` (pipeline + `.bat` + 手順書) and [#78](https://github.com/rimone0511/autopilot-log/pull/78) demo scripts. **New ID = new letter.** Do not reuse the 5258870 filled paste. |
| Expected | `prepped_not_sent` or `style_skipped` |
| GO-gate | `coconala_send_estimate: false` |
...
|---|---|---|---|---|---|---|
| **1** | Claude 社内アプリ群の全体設計（第1フェーズ） | ココナラ request | https://coconala.com/requests/5272940 · **`open_read`** 締切 **2026-09-22** | Sheets / GAS / Slack / Claude 設計相談。実装ではない。 | [#81](https://github.com/rimone0511/autopilot-log/pull/81) `05`/`06` · [#11](https://github.com/rimone0511/autopilot-log/pull/11) `03` · [#122](https://github.com/rimone0511/autopilot-log/pull/122) JP inquiry · **do-not-send** | `coconala_send_estimate: false` |
| **2** | マニュアル／取材動画の自動編集ワークフロー | ココナラ request | https://coconala.com/requests/5257064 · **`open_read`** 締切 **2026-09-20** | 再利用 WF + ソース + 手順。投稿は範囲外。 | [#92](https://github.com/rimone0511/autopilot-log/pull/92) `01` **angle only** · [#78](https://github.com/rimone0511/autopilot-log/pull/78) · **do-not-send** | `coconala_send_estimate: false` |
...
今やるのは **2つだけ**: ココナラ [5272940](https://coconala.com/requests/5272940) と [5257064](https://coconala.com/requests/5257064) を公式URLで再確認し、既存パックの文面を **そのID用に** ローカルで埋めて **送らない**。朝に済んだ Contra 貼り付け（Pro壁）・4403529 カバー・5258870 見積もり下書きは触らない。5259006 / 5263315 は Lステップ必須なのでスキップ。CW / Lancers / Upwork は机ごとスキップ。送信・公開は人が GO を書いたあと。
