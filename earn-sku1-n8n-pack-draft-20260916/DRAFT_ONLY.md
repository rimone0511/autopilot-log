...
SKU-0 is the previous Gumroad digital pack (starter intake). It is also
**unpublished** unless a later human pack says otherwise. This SKU-1 pack does not
publish SKU-0 either.
...
Markdown + JSON stubs only. Python posting-gate tests are unchanged.
