# SKU-3 pricing — PLACEHOLDER ONLY
...
## Relationship to SKU-0, SKU-1, and SKU-2

SKU-0 (starter intake), SKU-1 (inquiry classifier), and SKU-2 (approval-gated
notify) are **separate** products and separate price tokens
(`{{PRICE_USD_SKU0}}` / `{{PRICE_USD_SKU1}}` / `{{PRICE_USD_SKU2}}` live in
those packs, not here). Do not bundle them into SKU-3’s price box in this draft.
