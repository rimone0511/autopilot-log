# STOP before KYC — クラウディア（書類 + 自撮り）

Mode: **DRAFT_ONLY**  
Pack: `ops/earn/craudia-cu-handoff-20260916/`  
Pack date: 2026-09-16

本人確認は公式が **出金・取引の信頼** のゲートとして書く（FAQ 103 / 93）。このパックは出金も応募もスキル出品もしない。だから書類も自撮りも上げる理由は無い。
...
- [ ] NDA / クローズド案件の身分確認を KYC の代わりに進める
...
4. 有料ブースター（Craudia PRO 等）を KYC の代わりにしない。
