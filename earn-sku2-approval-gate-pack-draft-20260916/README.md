# SKU-2 n8n pack — DRAFT (unpublished)

Pack date: 2026-09-16
Desk: Gumroad (Wave A+ in the 2026-09-16 earn-ops queue; login is `done-draft`)
Product code: **SKU-2**
Predecessor: **SKU-1** (Gumroad inquiry classifier pack — labels, hold queue, human send, unpublished)
Mode: **DRAFT_ONLY — do not publish on Gumroad**

These files are a digital-product **draft** for a third n8n automation pack
(after SKU-0 starter intake and SKU-1 classifier).
...
SKU-2 is the next download: **approval-gated notify**. A draft outbound
(email, chat, webhook you already own) sits in a hold queue. A **human must
approve** before anything leaves. Missing, unknown, rejected, or timed-out
decisions **fail closed** — no outbound.
...
- Do not invent sales counts, GMV, delivery-time SLAs, or “auto-approved” rates.
...
|---|---|---|
| [BUYER-README.md](BUYER-README.md) | Buyer (zip contents) | How to import stubs, replace placeholders, keep outbound gated |
...
| [stubs/sku2-approval-gate.stub.json](stubs/sku2-approval-gate.stub.json) | Buyer stub | Inactive draft-notify hold graph |
| [stubs/sku2-outbound-notify.stub.json](stubs/sku2-outbound-notify.stub.json) | Buyer stub | Inactive approve/reject graph; outbound is NoOp |
...
- n8n Wait node (optional later; not required to import these stubs): `https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.wait/`
...
- n8n Wait: https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.wait/ (resume on webhook / form; optional later)
