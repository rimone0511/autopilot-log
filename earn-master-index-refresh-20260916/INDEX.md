...
| CU serial runbook | [`earn-cu-runbook-20260916/`](https://github.com/rimone0511/autopilot-log/tree/cursor/earn-cu-serial-runbook-2e17/earn-cu-runbook-20260916) | Wave A 残り（Fiverr→…→Freelancer.com）→ Wave B の gate `pass` のみ | CU | ready · draft · いまの skip はこの INDEX ポインタ | [#7](https://github.com/rimone0511/autopilot-log/pull/7) |
